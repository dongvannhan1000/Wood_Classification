...
dictLabels = pickle.load(open(r'../Weights and Misc/dictLabels.p', "rb"))
dictNames = pickle.load(open(r'../Weights and Misc/dictNames.p', "rb"))
...
#----------------------------------------------------------------------------
#save train data
extra_path = r'../Weights and Misc/'
print ("saving train patches")
write_hdf5(X_train, extra_path + train_patches)
write_hdf5(Y_train, extra_path + train_labels)

#save test data
print ("saving test patches")
write_hdf5(X_test, extra_path + test_patches)
write_hdf5(Y_test, extra_path + test_labels)
